...
class Ui_ImageTransfer(object):
    def setupUi(self, ImageTransfer):
        ...
        self.cancel.setGeometry(QtCore.QRect(400, 400, 112, 32))
        ...
        self.select_content.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.select_style.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.transfer.setMinimumSize(QtCore.QSize(100, 0))
